...
#include<cstdlib>
#include<string>
#include<windows.h> // Added for Sleep() function
        ...
        try {
            ...
            case 1:
                if (Tmon >= 10) {
                    ...
                    bill = bill + 10;
                    cout << "Your pet " << name << " has been fed \n" << "energy level: " << energy_lvl << endl;
                    if (bonding_lvl == 1) {
